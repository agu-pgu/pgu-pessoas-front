...
import UpdateParticipation from "../UpdateParticipation/UpdateParticipation";
          ...
          {peopleList.map((participation, index) => (
            <tr key={index} className="list-container-tr">
              <td className="list-container-td">
                {participation.participacaoNome}
              </td>
              <td className="list-container-td">
                {participation.participacaoDescricao}
              </td>
              <td className="list-container-td">
                {participation.participacaoTipoNome}
              </td>
