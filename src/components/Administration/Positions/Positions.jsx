  ...
  return (
    <div>
      ...
      <h1 className="formulario-h2">Administrativo - Cargo</h1>
        ...
        <h3 className="formulario-h3">Formulário administrativo de "Cargo"</h3>
          <form
          ...
          >
            ...
            <input
              ...
              required
            />
            <label className="form-label">*Cargo Descrição:</label>
            <input
              className="form-input"
              type="text"
              name="cargoDescricao"
              ...
              onChange={(event) => setCargoDescricao(event.target.value)}
              maxLength={255}
              required
            />
